...
case 1:	//All PLL Divided by 4
  lcdRegDataWrite(0x05,0x04);
  lcdRegDataWrite(0x07,0x04);
  lcdRegDataWrite(0x09,0x04);
  lcdRegDataWrite(0x06,(SCAN_FREQ*4/10)-1);
  lcdRegDataWrite(0x08,(DRAM_FREQ*4/10)-1);
  lcdRegDataWrite(0x0A,(CORE_FREQ*4/10)-1);
  break;
...
case 3:
  ...
  if( 50<SCAN_FREQ)
  {
  lcdRegDataWrite(0x05,0x02);				//PLL Divided by 2
  lcdRegDataWrite(0x06,(SCAN_FREQ*2/OSC_FREQ)-1);
  }
  ...
  {
  lcdRegDataWrite(0x05,0x08);				//PLL Divided by 16
  lcdRegDataWrite(0x06,(SCAN_FREQ*16/OSC_FREQ)-1);
  }
  if(SCAN_FREQ<=7)
  {
  lcdRegDataWrite(0x05,0x0A);				//PLL Divided by 32
